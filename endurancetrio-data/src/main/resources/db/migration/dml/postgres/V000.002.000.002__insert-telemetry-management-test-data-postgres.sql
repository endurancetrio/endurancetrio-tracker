...
-- Description: Inserts test data into EnduranceTrio Tracker telemetry management database table
--
...
INSERT INTO device_telemetry (id, account, device, record_time, latitude, longitude, active, version, created_at)
  VALUES
...
SELECT setval('seq_device_telemetry_id', 99, true);
