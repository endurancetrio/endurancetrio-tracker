...
-- The next call to nextval will return 95 + 5 = 100,
-- which will help to distinguish the test values since INCREMENT BY is 5
SELECT setval('seq_tracking_data_id', 95, TRUE);
