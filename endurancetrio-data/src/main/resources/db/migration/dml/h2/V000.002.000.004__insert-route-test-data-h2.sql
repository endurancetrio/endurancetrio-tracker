...
INSERT INTO route (id, reference, created_at) VALUES
    (1, '20260921ETU001-001S', CURRENT_TIMESTAMP);

-- Insert test data into route_segment table
INSERT INTO route_segment (id, route_id, segment_order, start_device, end_device, created_at) VALUES
...
CALL SETVAL('seq_route_id', 99);
CALL SETVAL('seq_route_segment_id', 99);
